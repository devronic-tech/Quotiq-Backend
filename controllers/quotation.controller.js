...
const { Quotation, QuotationSection, QuotationItem, Organization, Customer, Department } = require('../models/index.js');
 ...
 */
const patchQuotationStatus = asyncHandler(async (req, res) => {
  const tenantId = req.tenantId;
  const { id } = req.params;
